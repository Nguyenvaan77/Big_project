...
public class Publisher extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "PublisherName", "Address", "PhoneNo"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int c;
        try {
            pst = con.prepareStatement("Insert into Publisher(PublisherName,Address,PhoneNo)values(?,?,?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            pst = con.prepareStatement("Update Publisher set PublisherName = ?, Address = ?, PhoneNo = ? where ID = ?");
            pst.setString(1, name);
            pst.setString(2, address);
            pst.setInt(3, phone);
            pst.setInt(4, id);
